# /packages/intranet-reporting-finance/www/finance-vat-advanced.tcl
#
...
set start_years {2010 2011 2012 2013 2014 2015 2016 2017 2018 2019 2020}
...
set help_text "
<strong>VAT Report (Libro de IVA):</strong><br>
This reports lists customer invoices together with their principal VAT attributes for a given period.
<br>
	    ...
	    content [list \
		    ...
		    content [list \
				...
				"<nobr>$tax_amount_pretty</nobr>"
                                "<nobr>$invoice_total_pretty</nobr>"
			    } \
			    content {} \
		    ] \
	            footer {
