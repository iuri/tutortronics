...
--
-- $Id: timespan-create.sql,v 1.7 2016/01/12 17:45:44 cvs Exp $
...
comment on table time_intervals is 'A time interval is represented by two points in time.';	
...
BEGIN
	...
	insert into time_intervals (interval_id, start_date, end_date)
	values (v_interval_id, new__start_date, new__end_date);
...
--
	...
	-- @return Id of new timespan	
	--
CREATE OR REPLACE FUNCTION timespan__new(new__interval_id integer) 
RETURNS integer AS $$
DECLARE
BEGIN
