...
SELECT acs_log__debug('/packages/intranet-confdb/sql/postgresql/upgrade/upgrade-5.0.2.3.1-5.0.2.3.2.sql','');
...
'<input type=checkbox id=conf_item,$conf_item_id  name=conf_item_id.$conf_item_id>',
'', '', 1, '');
